...
public class OharaMoreArrays {
	...
	public static void main(String[] args) {
		...
		System.out.println("Avg len of " + Arrays.toString(s1) + " is " + OharaMoreArrays.problem1(s1));
		System.out.println();

		String[] s2 = {"alpha", "beta", "gamma", "delta", "gamma", "beta", "alpha"};
		System.out.println("The array " + Arrays.toString(s2) + " is a palindrome? "
				+ OharaMoreArrays.problem2(s2));
		System.out.println();

		double[] list1 = {16.1, 12.3, 22.2, 14.4};
		double[] list2 = {1.5, 4.3, 7.0, 19.5, 25.1, 46.2};
		System.out.println("The array " + Arrays.toString(list1) + " is sorted? "
				+ OharaMoreArrays.isSorted(list1));
		System.out.println("The array " + Arrays.toString(list2) + " is sorted? "
				+ OharaMoreArrays.isSorted(list2));
		System.out.println();

		int[] bar = {3, 8, 12, 2, 9, 17, 43, -8, 46};
		int[] baz = {4, 7, 3, 9, 12, -47, 3, 74};
		System.out.println("The array " + Arrays.toString(bar) + " is unique? "
				+ OharaMoreArrays.isUnique(bar));
		System.out.println("The array " + Arrays.toString(baz) + " is unique? "
				+ OharaMoreArrays.isUnique(baz));
	}
