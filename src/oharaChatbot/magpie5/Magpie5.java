...
public class Magpie5 {
	...
	private static final String[] wantingTriggers = {
		"I want"
	};
	private static final String[] wantingToTriggers = {
		"I want to"
	};
	...
	private static String transformToQuestion(String statement, String keyword,
			String question) {
	...
	private static String transformQuestionTense(String s, String key1,
			String key2, String question, String endTense) {
	...
	private static String getRandomResponse() {
		...
		return randomResponseList.get((int) (Math.random() * randomResponseList
				.size()));
	}
