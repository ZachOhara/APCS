...
public class OharaArrayListPractice {
	...
	public static void main(String[] args) {
		// Problem 1
		String[] wordsArr = {
				"be", "be", "is", "not", "or", "question", "that", "the", "to",
				"to"
		};
	...
	/*
	 * Each problem instructs to write a class, so each problem gets its own
	 * class.
	 * 
	 * Also, I made all the solutions generic. The code works exactly the same,
	 * but the functions will work with lists of any type, as long as that type
	 * has a meaningful equals() method.
	 */
