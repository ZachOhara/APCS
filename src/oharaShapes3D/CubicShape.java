...
public abstract class CubicShape extends Shape {
	 ...
	 * instanceof CubicShape)) throw new
	 * IllegalArgumentException("Compared object must be a CubicShape"); else {
	 * CubicShape cs = (CubicShape) other; return this.getLength() ==
	 * cs.getLength() && this.getWidth() == cs.getWidth() && this.getHeight() ==
	 * cs.getHeight(); } }
	 */
	
	// Get the String representation of the object
	public String toString() {
		return " with" + this.lengthToString() + "," + this.widthToString()
				+ this.heightToString();
	}
