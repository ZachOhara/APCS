...
public class Shape3DMain {
	...
	public static void main(String[] args) {
		...
		Shape3D[] shapes3D =
			{new Cube(7), new RectangularPrism(2, 3, 4), new SquarePyramid(4, 5), new Sphere(3),
				new CircularCone(4, 7), new Cylinder(3, 5)};
		Shape3D[] shapes3D2 =
			{new Cube(5), new RectangularPrism(2, 3, 4), new SquarePyramid(5, 5), new Sphere(3),
				new CircularCone(4, 8), new Cylinder(3, 5)};
		...
		System.out.println("\nDoes a sphere = a cube? " + shapes3D[0].equals(shapes3D[1]));
		System.out.println("\nDoes a circular cone = a cylinder? " + shapes3D[4].equals(shapes3D[5]));
		System.out.println("\nDoes a cube = a rectangular prism? "
				+ shapes3D[0].equals(new RectangularPrism(7, 7, 7)));
		RectangularPrism r = new RectangularPrism(7, 7, 7);
		System.out.println("\nDoes a rectangular prism = a cube? " + r.equals(shapes3D[0]));
	}
