...
public class Shape3DMain {
	...
	public static void main(String[] args) {
		...
		Shape3D[] shapes3D = {
				new Cube(7), new RectangularPrism(2, 3, 4),
				new SquarePyramid(4, 5), new Sphere(3), new CircularCone(4, 7),
				new Cylinder(3, 5)
		};
		Shape3D[] shapes3D2 = {
				new Cube(5), new RectangularPrism(2, 3, 4),
		...
		for (int i = 0; i < shapes3D.length; i++) {
			...
			System.out.println("\tSurface Area is: "
					+ shapes3D[i].getSurfaceArea());
			System.out.println("\tArray 2 shape is a " + shapes3D2[i]);
			System.out
					.println("\tDoes this shape = the shape in the second array? "
