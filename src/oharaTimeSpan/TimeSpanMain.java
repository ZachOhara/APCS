...
public class TimeSpanMain {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("t1: " + t1 + " is " + t1.getTotalHours() + " hours");
		...
		System.out
				.println("t2: " + t2 + " is " + t2.getTotalHours() + " hours");
		
		t1.add(t2);
		System.out.println("t1 + t2: " + t1 + " is " + t1.getTotalHours()
				+ " hours");
		
		TimeSpan t3 = new TimeSpan(5, 70);
		System.out
				.println("t3: " + t3 + " is " + t3.getTotalHours() + " hours");
		
		TimeSpan t4 = new TimeSpan(5, 70);
		System.out
				.println("t4: " + t4 + " is " + t4.getTotalHours() + " hours");
