...
/**
 * A class to make working with a file chooser easier for students. It uses a JFileChooser
 * to let the user pick a file and returns the chosen file name.
 *
...
public class FileChooser {
	...
	public static String pickPath(JFileChooser fileChooser) {
		...
		/*
		 * create a JFrame to be the parent of the file chooser open dialog if you don't do
		 * this then you may not see the dialog.
		 */
	...
	/**
	 * Method to let the user pick a file and return the full file name as a string. If the
	 * user didn't pick a file then the file name will be null.
	 *
	...
	public static String pickAFile() {
		...
		String mediaDir = FileChooser.getMediaDirectory();
		...
		// pick the file
		fileName = FileChooser.pickPath(fileChooser);
