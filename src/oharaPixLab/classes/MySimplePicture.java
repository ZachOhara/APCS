 ...
 */
public class MySimplePicture implements DigitalPicture
{
	 ...
	 */
	public MySimplePicture(String fileName)
	{
	 ...
	 */
	public MySimplePicture(int width, int height)
	{
	 ...
	 */
	public MySimplePicture(int width, int height, Color theColor)
	{
		this(width,height);
	 ...
	 */
	public MySimplePicture(SimplePicture copyPicture)
	{
	 ...
	 */
	public MySimplePicture(BufferedImage image)
	{
