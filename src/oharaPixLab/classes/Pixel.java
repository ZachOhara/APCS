...
/**
 * Class that references a pixel in a picture. Pixel stands for picture element where
 * picture is abbreviated pix. A pixel has a column (x) and row (y) location in a picture.
...
public class Pixel {
	...
	/**
	 * A constructor that takes the x and y location for the pixel and the picture the
	...
	/**
	 * Method to get the amount of alpha (transparency) at this pixel. It will be from
	 * 0-255.
	 *
	...
	public int getAlpha() {
		...
		/*
		 * get the value at the location from the picture as a 32 bit int with alpha, red,
		 * green, blue each taking 8 bits from left to right
		 */
	...
	/**
	 * Method to get the amount of red at this pixel. It will be from 0-255 with 0 being no
	 * red and 255 being as much red as you can have.
	 *
	...
	/**
	 * Method to get the amount of green at this pixel. It will be from 0-255 with 0 being
	 * no green and 255 being as much green as you can have.
	 *
	...
	/**
	 * Method to get the amount of blue at this pixel. It will be from 0-255 with 0 being
	 * no blue and 255 being as much blue as you can have.
	 *
	...
	public double colorDistance(Color testColor) {
		...
		double distance =
				Math.sqrt(redDistance * redDistance + greenDistance * greenDistance + blueDistance
						* blueDistance);
		return distance;
	}
	...
	public double getAverage() {
		double average = (this.getRed() + this.getGreen() + this.getBlue()) / 3.0;
		return average;
	}
	...
	public String toString() {
		return "Pixel row=" + this.getRow() + " col=" + this.getCol() + " red=" + this.getRed() + " green="
