...
public class ElevensBoard extends Board {
	...
	public boolean isLegal(List<Integer> selectedCards) {
		...
		return (len == 2 && containsPairSum11(selectedCards)) || (len == 3 && containsJQK(selectedCards));
	}
	...
	public boolean anotherPlayIsPossible() {
		List<Integer> cardlist = cardIndexes();
		return containsPairSum11(cardlist) || containsJQK(cardlist);
	}
