...
public class OharaSwapMin {
	...
	public static void main(String[] args) {
		...
		list.addAll(Arrays.asList(hamletWords)); // copy all values in hamletWords to list
	...
	public static void minToFront(ArrayList<Integer> list) {
		...
		ArrayList<Integer> ordered = new ArrayList<Integer>(list); // copy 'list' elements to new object
		Collections.sort(ordered);
		// The min is at ordered[0];
		list.remove(list.indexOf(ordered.get(0))); // find the index of the minimum, then remove it
