...
public class OharaBoolean {
	...
	public static void main(String[] args) {
		System.out.println(OharaBoolean.consecutive(1, 2, 3));
		System.out.println(OharaBoolean.consecutive(3, 4, 5));
		System.out.println(OharaBoolean.consecutive( -10, -8, -9));
		System.out.println(OharaBoolean.consecutive(3, 5, 7));
		System.out.println(OharaBoolean.consecutive(1, 2, 2));
		System.out.println(OharaBoolean.consecutive(7, 7, 9));

		System.out.println();
		System.out.println(OharaBoolean.monthApart(4, 15, 5, 22));
		System.out.println(OharaBoolean.monthApart(9, 19, 10, 17));
	}
